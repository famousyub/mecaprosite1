...
<table class="table table-bordered table-striped table-condensed">
	<thead>
		...
		<th class="parent-category">Email</th>
		<th class="parent-category">Join Date</th>
		<th class="parent-category">Last Login</th>
		<th class="parent-category">Permission</th>
	</thead>
	<tbody>
		...
		<tr>
			<td>
				<?php if($user['id'] != $user_data['id']) : ?>
					<a href="users.php?delete=<?= $user['id']; ?>"><i class="fa fa-times" aria-hidden="true"></i></a>
				<?php endif; ?>
			</td>
